...
#define STRING_CONFIG_H_AUTHOR "(Lucio, LCD ready, Makerthink, auto cal, new PID)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_PRINTRBOARD2
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "Makerthink"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {64.1,64.1,638.21,357}  // default steps per unit for Ultimaker
